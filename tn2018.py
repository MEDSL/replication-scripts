...
df = pd.read_csv('2018-tn-precinct-autoadapted.csv', dtype = official_dtypes)
df = df.fillna("")
df = df.replace('""',"")
...
df.to_csv("2018-tn-precinct-general-updated.csv",quoting=csv.QUOTE_NONNUMERIC,index=False)