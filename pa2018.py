...
file = 'ERStat_2018_G(114200)_20190111.txt'
...
#readme checking counties with discrepancies
df['readme_check'] = 'FALSE'
df.loc[(df['county_name']=='WESTMORELAND') & (df['office'].isin(['US SENATE','GOVERNOR'])),
    'readme_check'] = 'TRUE'
df.loc[(df['county_name']=='WESTMORELAND') & (df['office'] == 'STATE HOUSE') & (df['district'] == '059'),
    'readme_check'] = 'TRUE'
df.loc[(df['county_name']=='YORK') & (df['office'] == 'US HOUSE') & (df['district'] == '011'),
    'readme_check'] = 'TRUE'
...
df.to_csv('2018-pa-precinct-general-updated.csv',quoting=csv.QUOTE_NONNUMERIC, index=False)
